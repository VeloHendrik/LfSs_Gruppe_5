...
class Game:
    ...
    def drawTile(self, tile):
        ...
        # Hervorhebung des Gewinnerpfads in GOld
    ...
    def cloneGameState(self):
        # Erzeugt eine neue, reine logische Kopie des Spiels
        new_game = Game(matrix=copy.deepcopy(self.matrix))
        new_game.current_player = self.current_player
        new_game.num_emptyTiles = self.num_emptyTiles
        return new_game
